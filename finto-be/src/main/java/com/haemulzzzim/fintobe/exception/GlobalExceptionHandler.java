package com.haemulzzzim.fintobe.exception;
...
public class GlobalExceptionHandler {
	...
	protected ResponseEntity<ErrorResponse> handleDataIntegrityViolationException(DataIntegrityViolationException e) {
		...
		String message = "이미 등록된 값이 있습니다.";
		if (e.getMessage() != null) {
			if (e.getMessage().contains("empno")) {
				message = "이미 있는 사원번호입니다.";
			} else if (e.getMessage().contains("email")) {
				message = "이미 있는 이메일입니다.";
			}
		}
		EntityAlreadyExistException ex = new EntityAlreadyExistException(message, ErrorCode.USER_ALREADY_EXIST);
